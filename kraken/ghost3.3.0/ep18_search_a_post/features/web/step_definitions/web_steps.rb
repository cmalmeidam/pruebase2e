...
")
  ...
  Then(/^I search a post$/) do
    @driver.execute_script("document.getElementsByClassName('ember-power-select-search')[0].childNodes[3].value = 'Prueba'")
    @driver.switch_to.active_element.send_keys(' Ghost')
  end
